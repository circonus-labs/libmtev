...
extern void* acosw(aco_t* from_co, aco_t* to_co) __asm("acosw");  // asm

extern void aco_save_fpucw_mxcsr(void* p) __asm("aco_save_fpucw_mxcsr");  // asm

extern void aco_funcp_protector_asm(void) __asm("aco_funcp_protector_asm"); // asm
