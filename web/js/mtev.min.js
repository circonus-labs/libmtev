...
return null;}
function $badge(n,t){if(!t)t="default";return $("<span class=\"badge badge-pill badge-"+t+"\"/>").text(n);}
...
var last_log_idx;function refresh_logs(force){var qs="";var $c=$("#main-log-window");if($c.length<1)return;if(typeof(last_log_idx)!=='undefined')
