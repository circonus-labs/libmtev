...
var mtev={loaded:false,capa:{},stats:{eventer:{jobq:{},callbacks:{}}}};(function(){var track_once={}
...
used+=detail.backlog+detail.inflight+detail.total_jobs+detail.concurrency;$tr.append($("<td/>").html(jobq));var $conc=$("<td class=\"text-center\"/>");if(detail.desired_concurrency==0){$tr.attr("class","backq");$conc.html("N/A");}
...
function refreshMtevStats(cb){if(track_once.mtevstats==true)return;track_once.mtevstats=true;var st=jQuery.ajax("/mtev/stats.json");st.always(function(){track_once.mtevstats=false;});st.done(function(r){mtev.stats=r.mtev;mtev.updatePerfUI(r,["mtev"]);$("#internal-stats tbody").removeClass("d-none");if(cb)cb();});}
